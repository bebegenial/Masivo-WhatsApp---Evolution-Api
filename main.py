        ...
        try:
            ...
            if message_text:
                ...
                payload = {
                    ...
                    "text": message_text  # <-- CAMBIO AQUÍ: "text" en lugar de textMessage.text
                }
            ...
            if success and image_file is not None:
                ...
                media_payload = {
                    ...
                    "mediatype": "image",  # <-- CAMBIO: Ya no está dentro de mediaMessage
                    "caption": caption if caption else "",
                    "media": image_base64
                }
            ...
            # Genera un delay aleatorio entre 20 y el valor de 'delay'
